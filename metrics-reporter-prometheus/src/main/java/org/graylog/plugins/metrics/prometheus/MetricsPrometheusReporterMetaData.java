...
public class MetricsPrometheusReporterMetaData implements PluginMetaData {

    @Override
    public String getUniqueId() {
        return MetricsPrometheusReporterPlugin.class.getCanonicalName();
    }
    ...
    public String getDescription() {
        return "A plugin for reporting internal Graylog metrics to Prometheus.";
    }
