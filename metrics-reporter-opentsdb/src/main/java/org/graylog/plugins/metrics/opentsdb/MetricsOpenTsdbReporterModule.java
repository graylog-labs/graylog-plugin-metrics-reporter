...
import org.graylog.plugins.metrics.opentsdb.providers.OpenTsdbProvider;
import org.graylog.plugins.metrics.opentsdb.providers.OpenTsdbReporterProvider;
...
public class MetricsOpenTsdbReporterModule extends PluginModule {
    @Override
    public Set<? extends PluginConfigBean> getConfigBeans() {
        return Collections.singleton(new MetricsOpenTsdbReporterConfiguration());
    }

    @Override
    protected void configure() {
        bind(OpenTsdb.class).toProvider(OpenTsdbProvider.class).asEagerSingleton();
        bind(OpenTsdbReporter.class).toProvider(OpenTsdbReporterProvider.class);

        addConfigBeans();
        addInitializer(MetricsOpenTsdbReporterService.class);
    }
}
