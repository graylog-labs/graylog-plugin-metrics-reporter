...
public class MetricsElasticsearchReporterPlugin implements Plugin {
    @Override
    public PluginMetaData metadata() {
        return new MetricsElasticsearchReporterMetaData();
    }

    @Override
    public Collection<PluginModule> modules() {
        return Collections.singleton(new MetricsElasticsearchReporterModule());
    }
}
