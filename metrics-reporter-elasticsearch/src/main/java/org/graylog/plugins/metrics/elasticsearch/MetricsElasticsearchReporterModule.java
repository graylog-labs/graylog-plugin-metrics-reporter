...
import org.graylog.plugins.metrics.elasticsearch.providers.ElasticsearchReporterProvider;
...
public class MetricsElasticsearchReporterModule extends PluginModule {
    @Override
    public Set<? extends PluginConfigBean> getConfigBeans() {
        return Collections.singleton(new MetricsElasticsearchReporterConfiguration());
    }

    @Override
    protected void configure() {
        bind(ElasticsearchReporter.class).toProvider(ElasticsearchReporterProvider.class);

        addConfigBeans();
        addInitializer(MetricsElasticsearchReporterService.class);
    }
}
