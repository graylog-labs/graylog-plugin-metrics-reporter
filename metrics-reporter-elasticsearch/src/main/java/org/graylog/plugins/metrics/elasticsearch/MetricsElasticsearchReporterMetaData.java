...
public class MetricsElasticsearchReporterMetaData extends BasePluginMetaData {
    @Override
    protected String getPluginProperties() {
        return "org.graylog.plugins.metrics-reporter-elasticsearch/graylog-plugin.properties";
    }
