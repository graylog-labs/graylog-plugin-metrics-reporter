...
public class MetricsSlf4jReporterMetaData implements PluginMetaData {

    @Override
    public String getUniqueId() {
        return MetricsSlf4jReporterPlugin.class.getCanonicalName();
    }
    ...
    public String getDescription() {
        return "A plugin for reporting internal Graylog metrics via SLF4J.";
    }
