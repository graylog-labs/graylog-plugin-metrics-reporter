...
import org.graylog.plugins.metrics.ganglia.providers.GMetricProvider;
import org.graylog.plugins.metrics.ganglia.providers.GangliaReporterProvider;
...
public class MetricsGangliaReporterModule extends PluginModule {
    @Override
    public Set<? extends PluginConfigBean> getConfigBeans() {
        return Collections.singleton(new MetricsGangliaReporterConfiguration());
    }
